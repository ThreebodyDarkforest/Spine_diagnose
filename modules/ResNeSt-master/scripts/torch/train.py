...
import logging
import argparse
from datasets import get_dataloader, SpineDataSet
...
def main_worker(gpu, ngpus_per_node, args, cfg):
    ...
    trainset = SpineDataSet('/home/marcus/Learn/DL/Spine_diagnose/tools/datasets/classify/train/classA', transform_train)
    valset = SpineDataSet('/home/marcus/Learn/DL/Spine_diagnose/tools/datasets/classify/val/classA', transform_val)
    ...
    #train_loader, train_sampler = get_dataloader('/home/marcus/Learn/DL/Spine_diagnose/test/classify/train', cfg.TRAINING.BATCH_SIZE, num_workers=cfg.TRAINING.WORKERS)
    #val_loader, val_sampler = get_dataloader('/home/marcus/Learn/DL/Spine_diagnose/test/classify/val', 1, num_workers=cfg.TRAINING.WORKERS)
    ...
    def train(epoch):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            data = data.to(torch.device(args.gpu))
            target = target[:, 0]
